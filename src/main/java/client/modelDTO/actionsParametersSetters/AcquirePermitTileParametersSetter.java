 ...
 *
 */
public class AcquirePermitTileParametersSetter implements ActionParametersSetter {
	 ...
	 */
	public AcquirePermitTileParametersSetter(AcquirePermitTileDTO selectedAction) {
