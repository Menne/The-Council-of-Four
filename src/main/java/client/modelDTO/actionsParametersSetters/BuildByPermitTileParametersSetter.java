 ...
 *
 */
public class BuildByPermitTileParametersSetter implements ActionParametersSetter {
	 ...
	 */
	public BuildByPermitTileParametersSetter(BuildByPermitTileDTO selectedAction) {
