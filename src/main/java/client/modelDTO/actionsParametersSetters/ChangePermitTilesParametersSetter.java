 ...
 *
 */
public class ChangePermitTilesParametersSetter implements ActionParametersSetter {
	 ...
	 */
	public ChangePermitTilesParametersSetter(ChangePermitTilesDTO selectedAction) {
