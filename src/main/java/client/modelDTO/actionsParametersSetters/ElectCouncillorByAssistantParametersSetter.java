 ...
 *
 */
public class ElectCouncillorByAssistantParametersSetter implements ActionParametersSetter {
	 ...
	 */
	public ElectCouncillorByAssistantParametersSetter(ElectCouncillorByAssistantDTO selectedAction) {
