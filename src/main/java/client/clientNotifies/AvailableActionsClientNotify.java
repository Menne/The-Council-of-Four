 ...
 *
 */
public class AvailableActionsClientNotify implements ClientViewNotify {
	 ...
	 */
	public AvailableActionsClientNotify(List<ActionDTO> availableActions, String message) {
