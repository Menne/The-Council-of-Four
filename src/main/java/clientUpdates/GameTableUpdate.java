...
import client.clientNotifies.GameTableClientNotify;
 ...
 *
 */
public class GameTableUpdate implements ClientUpdate{
	 ...
	 */
	public GameTableUpdate(GameTableDTO gameTableDTO, boolean startGame) {
	...
	public void updateModel(GameDTO gameDTOtoupdate) {
		...
		gameDTOtoupdate.notifyObserver(new GameTableClientNotify(this.startGame));
	}
